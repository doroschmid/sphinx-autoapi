...
class PythonPythonMapper(PythonMapperBase):
    ...
    :attr name: The name given to this object.
    :type name: str
    :attr id: A unique identifier for this object.
    :type id: str
    :attr children: The members of this object.
    :type children: list(PythonPythonMapper)
    """
